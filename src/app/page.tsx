...
const HomePage = () => {
  ...
  return (
    <Fragment>
      <section className="w-full flex flex-row justify-center pt-[86px] pb-[40px]">
        <div className="relative w-full wrapper flex flex-row justify-center">
          <div className="w-[700px] flex flex-col items-center ">
            ...
            <Link href='/take-advise' className="my-[24px] rounded-[44px] bg-[var(--nav-color)] text-white tracking-[-0.2px] py-[8px] px-[24px] text-[16px] font-medium leading-[32px] flex flex-row justify-center items-center hover:bg-gray-900">
            ...
            {features.map(({ element, color, desc, title }) => (
              <div className="border-[1px] border-gray-200 p-[24px] space-x-[16px] flex flex-row items-start text-[16px] leading-[32px] rounded-[8px] mb-[24px]">
                <div
                  ...
                  className="bg-purple-100 rounded-full h-[48px] w-[48px] flex flex-row justify-center items-center"
                >
                  {element}
                </div>
      ...
      <section className="w-full flex flex-col items-center mt-[46px] mb-[90px]">
        <h1 className="text-[64px] leading-[72px] tracking-[-1.6px] font-medium mb-[24px]">
          Meet the team
        </h1>
        ...
        <div className="w-full flex flex-row justify-center ">
          <div className="w-full wrapper flex flex-row justify-center">
            <div className="w-full space-x-[24px] flex flex-row max-w-[858px]">
              {team.map(({ desig, img, link, name }) => (
                <div className="w-full flex flex-col items-center border-gray-200 border-[1px] p-[24px] rounded-[36px] text-[16px]">
